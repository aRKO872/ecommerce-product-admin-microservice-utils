...
func (x *GRPCRequest) GetMetadata() map[string]string {
	if x != nil {
		return x.Metadata
	}
	return nil
...
const file_common_proto_rawDesc = "" +
	"\n" +
	"\fcommon.proto\x12\x06common\"\x9d\x01\n" +
	"\vGRPCRequest\x12\x12\n" +
	"\x04Body\x18\x01 \x01(\fR\x04Body\x12=\n" +
	"\bMetadata\x18\x02 \x03(\v2!.common.GRPCRequest.MetadataEntryR\bMetadata\x1a;\n" +
	"\rMetadataEntry\x12\x10\n" +
	"\x03key\x18\x01 \x01(\tR\x03key\x12\x14\n" +
	"\x05value\x18\x02 \x01(\tR\x05value:\x028\x01\"\"\n" +
	"\fGRPCResponse\x12\x12\n" +
	"\x04Body\x18\x01 \x01(\fR\x04BodyBKZIgithub.com/aRKO872/ecommerce-product-admin-microservice-utils/grpc/commonb\x06proto3"
...
var file_common_proto_goTypes = []any{
	(*GRPCRequest)(nil),  // 0: common.GRPCRequest
	(*GRPCResponse)(nil), // 1: common.GRPCResponse
	nil,                  // 2: common.GRPCRequest.MetadataEntry
}
var file_common_proto_depIdxs = []int32{
	2, // 0: common.GRPCRequest.Metadata:type_name -> common.GRPCRequest.MetadataEntry
